...
parser.add_argument('--gens', type=int, help='Number of generations', default=500)
parser.add_argument('--grn_file', type=bool, help='Experts from GRN file', default=False)
parser.add_argument('--env', type=str, help='GYM env', default="GymJsbsim-TaxiControlTask-A320-v0")
parser.add_argument('--nin', type=int, help='GYM number of input', default=17)
